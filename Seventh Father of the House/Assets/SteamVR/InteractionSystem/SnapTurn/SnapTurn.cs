    ...
    public class SnapTurn : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (canRotate && snapLeftAction != null && snapRightAction != null && snapLeftAction.activeBinding && snapRightAction.activeBinding)
            {
                ...
                bool rightHandValid = (player.rightHand && player.rightHand.currentAttachedObject == null) ||
                ...
                bool leftHandValid = (player.leftHand && player.leftHand.currentAttachedObject == null) ||
